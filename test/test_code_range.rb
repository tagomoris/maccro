...
class CodeRangeTest < ::Test::Unit::TestCase
  ...
  test 'from_node' do
    ast1 = proc_to_ast(CodeRangeTest.instance_method(:example_method))
...
EOC
    ...
    ast2 = proc_to_ast(CodeRangeTest.instance_method(:e1))
    range2 = Maccro::CodeRange.from_node(ast2)
    code2 = "def e1; end"
    assert_equal code2, range2.source(__FILE__)

    ast3 = proc_to_ast(CodeRangeTest.instance_method(:e2))
